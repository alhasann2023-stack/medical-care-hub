...
export const INITIAL_PAYMENTS: Payment[] = [
  {
    ...
    confirmedAt: new Date(Date.now() - 3600 * 1000 * 24 * 2).toISOString(),
  ...
  },
  {
    ...
    paidAt: new Date(Date.now() - 3600 * 1000 * 24 * 1).toISOString(),
    createdAt: new Date(Date.now() - 3600 * 1000 * 24 * 1).toISOString(),
    confirmedAt: new Date(Date.now() - 3600 * 1000 * 24 * 1).toISOString(),
  ...
  },
  {
    ...
    confirmedAt: new Date(Date.now() - 3600 * 1000 * 12).toISOString(),
  ...
  },
  {
    ...
    paidAt: new Date(Date.now() - 3600 * 1000 * 6).toISOString(),
    createdAt: new Date(Date.now() - 3600 * 1000 * 6).toISOString(),
    confirmedAt: new Date(Date.now() - 3600 * 1000 * 6).toISOString(),
  ...
  },
  {
    ...
    bankTransferDetails: {
      ...
      transferDate: new Date(Date.now() - 3600 * 1000 * 18).toISOString(),
      senderPhone: '+966501234567',
      notes: 'تم التحقق والمطابقة مع كشف الحساب المصرفي واعتماد السداد'
    },
    paidAt: new Date(Date.now() - 3600 * 1000 * 18).toISOString(),
    createdAt: new Date(Date.now() - 3600 * 1000 * 18).toISOString(),
    confirmedAt: new Date(Date.now() - 3600 * 1000 * 17).toISOString(),
    updatedAt: new Date(Date.now() - 3600 * 1000 * 17).toISOString()
  }
];
