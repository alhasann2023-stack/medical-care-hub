          ...
          <div className="bg-amber-50 border-b border-amber-200 p-3.5 px-5 flex items-start gap-3 text-xs text-amber-950">
            ...
            <div>
              ...
              <p className="text-[11px] text-amber-800/90 mt-0.5">
                تتيح مبادرة العيادة استشارة مجانية واحدة فقط لكل حساب مريض. هذه الاستشارة الحالية خاضعة للرسوم الرسمية المقررة ({baseConsultationFee} ر.ي) وسيتم توجيهك للسداد الإلكتروني المباشر.
              </p>
            </div>
          </div>
        ) : null}
