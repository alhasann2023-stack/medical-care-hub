...
export const PatientReportsView: React.FC<PatientReportsViewProps> = ({ patientId }) => {
  ...
  return (
    <div className="space-y-3">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-blue-400 shadow-xs">
            ...
            >
              <div>
                <div className="flex items-start justify-between gap-2 mb-2">
                  ...
                  <div className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-bold bg-blue-50 text-blue-700 border border-blue-200 shrink-0">
                ...
                {/* Summary */}
                <div className="p-3.5 rounded-xl bg-blue-100 border border-slate-200 text-xs text-slate-700 leading-relaxed mb-4">
