// React typings are not installed in this project; suppress JSX runtime diagnostics here.
// @ts-nocheck

// React typings are not installed in this project; suppress the untyped module diagnostic here.
// @ts-ignore TS7016: React is provided at runtime.
...
}: ConsultationReminderBannerProps) => {
    ...
    <div className="bg-gradient-to-r from-amber-500 via-orange-500 to-amber-600 rounded-2xl p-4 sm:p-5 text-white shadow-xl border-2 border-amber-300 relative overflow-hidden animate-in slide-in-from-top-4 duration-300">
      ...
      <div className="mt-3 pt-3 border-t border-white/20 flex flex-wrap items-center justify-between gap-2 text-xs">
        ...
        >
          ...
          <span>{showChecklist ? 'إخفاء نصائح الاستعداد للاستشارة' : 'عرض نصائح الاستعداد السريع للاستشارة '}</span>
        </button>
