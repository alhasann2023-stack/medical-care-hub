        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full p-3 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-300 text-xs outline-none focus:ring-2 focus:ring-indigo-600"
            />
          </div>
